...
@Stateless
public class ServicioDeCrudGenerico {

    //Servicios dde CRUD de la base de datos y para integrar JPA
    private static final Logger LOGGER = Logger.getLogger(ServicioDeCrudGenerico.class.getSimpleName());
